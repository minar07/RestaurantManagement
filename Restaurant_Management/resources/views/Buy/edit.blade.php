	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Item:</strong>
                {!! Form::select('item_id', $rawMaterial,[], array('class' => 'form-control selectpicker','data-live-search' => 'true')) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::hidden('user_id', null, array('placeholder' => 'User Id','class' => 'form-control')) !!}
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Rate:</strong>
